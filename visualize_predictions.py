...
def visualize():
    ...
    # We want to plot a few key conditions
    selected_conditions = [
    ...
    for cond_name in selected_conditions:
        ...
        # Create dense time grid for smooth prediction curve
